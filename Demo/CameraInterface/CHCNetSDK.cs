...
namespace ETCF
{
    ...
    public class CHCNetSDK
    {
        ...
        ******************************************************************************/
        ...
        //车辆品牌主类型
        public static string[] VLR_VEHICLE_CLASS=new string[239]{
            "其它",                            //VLR_OTHER           = 0,                   
            "大众",                            //VLR_VOLKSWAGEN      = 1,                   
            "别克",                            //VLR_BUICK           = 2,                   
            "宝马",                            //VLR_BMW             = 3,                   
            ...
            "奥迪",                            //VLR_AUDI            = 9,                   
            "马自达",                          //VLR_MAZDA           = 10,                  
            "雪佛兰",                          //VLR_CHEVROLET       = 11,                  
            "雪铁龙",                          //VLR_CITROEN         = 12,                  
            "现代",                            //VLR_HYUNDAI         = 13,                  
            "奇瑞",                            //VLR_CHERY           = 14,                  
            "起亚",                            //VLR_KIA             = 15,                  
            "荣威",                            //VLR_ROEWE           = 16,                  
            "三菱",                            //VLR_MITSUBISHI      = 17,                  
            "斯柯达",                          //VLR_SKODA           = 18,                  
            "吉利",                            //VLR_GEELY           = 19,                  
            "中华",                            //VLR_ZHONGHUA        = 20,                  
            "沃尔沃",                          //VLR_VOLVO           = 21,                  
            ...
            "众泰",                            //VLR_ZOTYE           = 51,                  
            "昌河",                            //VLR_CHANGHE         = 52,                  
            "厦门金龙(金旅)",                  //VLR_XMKINGLONG      = 53,                  
            "上海汇众(上汽集团)",              //VLR_HUIZHONG        = 54,                  
            "苏州金龙",                        //VLR_SZKINGLONG      = 55,                  
            "海格",                            //VLR_HIGER           = 56,                  
            "宇通",                            //VLR_YUTONG          = 57,                  
            "中国重汽",                        //VLR_CNHTC           = 58,                  
            "北奔重卡",                        //VLR_BEIBEN          = 59,                  
            ...
            "黄海",                            //VLR_HUANGHAI        = 62,                  
            "老款长城",                        //VLR_OLDWALL         = 63,                  
            "长安商用",                        //VLR_CHANACOMMERCIAL = 64,                  
            "保时捷",                          //VLR_PORSCHE         = 65,                  
            "凯迪拉克",                        //VLR_CADILLAC        = 66,                  
            "英菲尼迪",                        //VLR_INFINITI        = 67,                  
            "吉利全球鹰(吉利)",                //VLR_GLEAGLE         = 68,                  
            "JEEP(吉普)",                      //VLR_JEEP            = 69,                  
            "路虎",                            //VLR_LANDROVER       = 70,                  
            "长丰",                            //VLR_CHANGFENG       = 71,                  
            "长安奔奔(长安)",                  //VLR_BENNI           = 72,                  
            "福田时代(时代)",                  //VLR_ERA             = 73,                  
            "长安金牛星(长安商用)",            //VLR_TAURUS          = 74,                  
            "长安逸动",                        //VLR_EADO            = 75,                  
            "陕汽",                            //VLR_SHANQI          = 76,                  
            "红岩汽车(上汽依维柯红岩)",        //VLR_HONGYAN         = 77,                  
            "霸龙汽车(东风柳汽)",              //VLR_DRAGON          = 78,                  
            "江淮JAC (江淮)",                  //VLR_JACTEXT         = 79,                  
            "江淮现代客车 (江淮)",             //VLR_JACBUS          = 80,                  
            "安凯客车",                        //VLR_ANKAI           = 81,                  
            "申龙客车",                        //VLR_SHENLONG        = 82,                  
            "大宇客车",                        //VLR_DAEWOO          = 83,                  
            "五征汽车",                        //VLR_WUZHENG         = 84,                  
            "MAN汽车",                         //VLR_MAN             = 85,                  
            "中通客车",                        //VLR_ZHONGTONG       = 86,                  
            "宝骏",                            //VLR_BAOJUN          = 87,                  
            "北汽威旺",                        //VLR_BQWEIWANG       = 88,                  
            "传祺",                            //VLR_TRUMPCHE        = 89,                  
            "陆风",                            //VLR_LUFENG          = 90,                  
            "海马郑州",                        //VLR_HMZHENGZHOU     = 91,                  
            "北京汽车",                        //VLR_BEIJING         = 92,                  
            "中顺",                            //VLR_ZHONGSHUN       = 93,                  
            "威麟汽车",                        //VLR_WEILIN          = 94,                  
            "欧宝",                            //VLR_OPEL            = 95,                  
            "开瑞",                            //VLR_KARRY           = 96,                  
            "华普汽车",                        //VLR_SMA             = 97,                  
            "华普汽车文字SMA",                 //VLR_SMATEXT         = 98,                  
            "江铃驭胜",                        //VLR_YUWIN           = 99,                  
            "宝马MINI",                        //VLR_MINI            = 100,                 
            "丰田MARKX ",                      //VLR_MARK            = 101,                 
            "哈弗HAVAL",                       //VLR_HAVAL           = 102,                 
            "讴歌",                            //VLR_OGA             = 103,                 
            "启辰",                            //VLR_VENUCIA         = 104,                 
            "比亚迪样式2 (比亚迪)",            //VLR_BYD2            = 105,                 
            "奔驰SMART",                       //VLR_SMART           = 106,                 
            "北京汽车制造厂BAW",               //VLR_BAW             = 107,                 
            "纳智捷",                          //VLR_LUXGEN          = 108,                 
            "野马",                            //VLR_YEMA            = 109,                 
            "中兴",                            //VLR_ZTE             = 110,                 
            "理念",                            //VLR_EVERUS          = 111,                 
            "克莱斯勒",                        //VLR_CHRYSLER        = 112,                 
            "吉奥汽车",                        //VLR_GONOW           = 113,                 
            "松花江",                          //VLR_SHJIANG         = 114,                 
            "瑞麟",                            //VLR_RUILIN          = 115,                 
            "福达",                            //VLR_FORTA           = 116,                 
            ...
            "黑豹",                            //VLR_HEIBAO          = 118,                 
            "唐骏",                            //VLR_TKING           = 119,                 
            "唐骏文字",                        //VLR_TKINGTEXT       = 120,                 
            "福迪",                            //VLR_FODAY           = 121,                 
            "莲花汽车",                        //VLR_LOTUS           = 122,                 
            "南骏",                            //VLR_NANJUN          = 123,                 
            "双环汽车",                        //VLR_SHUANGHUAN      = 124,                 
            "哈飞赛豹",                        //VLR_SAIBAO          = 125,                 
            "华泰",                            //VLR_HAWTAI          = 126,                 
            "永源飞碟",                        //VLR_LIFO            = 127,                 
            "永源汽车",                        //VLR_JONWAY          = 128,                 
            "福龙马",                          //VLR_FULONGMA        = 129,                 
            "潍力",                            //VLR_WEILI           = 130,                 
            "江淮安驰",                        //VLR_ANCHI           = 131,                 
            "派喜",                            //VLR_PAIXI           = 132,                 
            "海格HIGER文字",                   //VLR_HIGERTEXT       = 133,                 
            "广汽日野轻卡",                    //VLR_RIYECAR         = 134,                 
            "广汽日野重卡",                    //VLR_RIYETRUCK       = 135,                 
            "江南",                            //VLR_JIANGNAN        = 136,                 
            "老款众泰",                        //VLR_OLDZOTYE        = 137,                 
            "老款夏利",                        //VLR_OLDXIALI        = 138,                 
            "新奥驰",                          //VLR_NEWAOCHI        = 139,                 
            "王牌重汽",                        //VLR_CDW             = 140,                 
            "王牌重汽文字",                    //VLR_CDWTEXT         = 141,                 
            "本田思铭",                        //VLR_CIIMO           = 142,                 
            "长安谛艾仕",                      //VLR_CHANADS         = 143,                 
            "道奇",                            //VLR_DS              = 144,                 
            "现代劳恩斯酷派",                  //VLR_ROHENS          = 145,                 
            "燕台",                            //VLR_YANTAI          = 146,                 
            "双龙",                            //VLR_SHUANGLONG      = 147,                 
            "时代风菱",                        //VLR_FENGLING        = 148,                 
            "新凯",                            //VLR_XINKAI          = 149,                 
            "GMC",                             //VLR_GMC             = 150,                 
            "上汽大通",                        //VLR_DATONG          = 151,                 
            "北汽银翔",                        //VLR_BQYINXIANG      = 152,                 
            "新奇瑞",                          //VLR_NEWCHERY        = 153,                 
            "牡丹",                            //VLR_MUDAN           = 154,                 
            "大运汽车",                        //VLR_DAYUN           = 155,                 
            "东沃汽车",                        //VLR_DONGWO          = 156,                 
            "联合汽车",                        //VLR_UNION           = 157,                 
            "春洲客车",                        //VLR_CHUNZHOU        = 158,                 
            "三一重工",                        //VLR_SANY            = 159,                 
            "亚星客车",                        //VLR_YAXING          = 160,                 
            "恒通客车",                        //VLR_HENGTONG        = 161,                 
            "少林客车",                        //VLR_SHAOLIN         = 162,                 
            "青年客车",                        //VLR_YOUNG           = 163,                 
            "十通",                            //VLR_STOM            = 164,                 
            "三环",                            //VLR_SANHUAN         = 165,                 
            "徐工",                            //VLR_XUGONG          = 166,                 
            "北方汽车",                        //VLR_BEIFANG         = 167,                 
            "江环货车",                        //VLR_JIANGHUAN       = 168,                 
            "北京农用",                        //VLR_BJFARM          = 169,                 
            "新大地汽车",                      //VLR_NEWDADI         = 170,                 
            "申沃客车",                        //VLR_SUNWIN          = 171,                 
            "英田",                            //VLR_YINGTIAN        = 172,                 
            "轻骑",                            //VLR_QINGQI          = 173,                 
            "楚风汽车",                        //VLR_CHUFENG         = 174,                 
            "斯堪尼亚",                        //VLR_SCANIA          = 175,                 
            "九龙客车",                        //VLR_JIULONG         = 176,                 
            "友谊客车",                        //VLR_YOUYI           = 177,                 
            "上饶客车",                        //VLR_SHANGRAO        = 178,                 
            "吉江",                            //VLR_JIJIANG         = 179,                 
            "扬子客车",                        //VLR_YANGZI          = 180,                 
            "西沃客车",                        //VLR_XIWO            = 181,                 
            "长江客车",                        //VLR_CHANGJIANG      = 182,                 
            "武夷",                            //VLR_WUYI            = 183,                 
            "成都客车",                        //VLR_CHENGDU         = 184,                 
            "天马",                            //VLR_TIANMA          = 185,                 
            "宝龙",                            //VLR_BAOLONG         = 186,                 
            "新雅途",                          //VLR_NEWYATU         = 187,                 
            "起亚霸锐",                        //VLR_BARUI           = 188,                 
            ...
            "大迪",                            //VLR_DADI            = 192,                 
            "富奇",                            //VLR_FUQI            = 193,                 
            "航天汽车",                        //VLR_HANGTIAN        = 194,                 
            "恒天汽车",                        //VLR_HENGTIAN        = 195,                 
            "江铃轻汽",                        //VLR_JMCCAR          = 196,                 
            "卡尔森汽车",                      //VLR_KAERSEN         = 197,                 
            "卡威汽车",                        //VLR_KAWEI           = 198,                 
            "兰博基尼",                        //VLR_LANBOJINI       = 199,                 
            "玛莎拉蒂",                        //VLR_MASHALADI       = 200,                 
            "舒驰客车",                        //VLR_SHUCHI          = 201,                 
            "实力客车",                        //VLR_SHILI           = 202,                 
            "中客华北",                        //VLR_HUABEI          = 203,                 
            "上汽仪征",                        //VLR_YIZHENG         = 204,                 
            "春兰汽车",                        //VLR_CHUNLAN         = 205,                 
            "大发汽车",                        //VLR_DAFA            = 206,                 
            "神野汽车",                        //VLR_SHENYE          = 207,                 
            "法拉利汽车",                      //VLR_FALALI          = 208,                 
            "福星汽车",                        //VLR_FUXING          = 209,                 
            "安源客车",                        //VLR_ANYUAN          = 210,                 
            "京华客车",                        //VLR_JINGHUA         = 211,                 
            "太湖客车",                        //VLR_TAIHU           = 212,                 
            "五洲龙",                          //VLR_WUZHOULONG      = 213,                 
            "常隆客车",                        //VLR_CHANGLONG       = 214,                 
            "悦西客车",                        //VLR_YUEXI           = 215,                 
            "神马客车",                        //VLR_SHENMA          = 216,                 
            "庐山牌",                          //VLR_LUSHAN          = 217,                 
            "万丰牌",                          //VLR_WANFENG         = 218,                 
            "广州云豹",                        //VLR_GZYUNBAO        = 219,                 
            "中大汽车",                        //VLR_ZHONGDA         = 220,                 
            "三轮车",                          //VLR_THREEWHEEL      = 221,                 
            "二轮车",                          //VLR_TWOWHEEL        = 222,                 
            "金杯JBC",                         //VLR_JBC             = 223,                 
            "扬子江客车",                      //VLR_YZJIANG         = 224,                 
            "南骏CNJ",                         //VLR_CNJ             = 225,                 
            "福田时代文字",                    //VLR_FORLAND         = 226,                 
            "农用车",                          //VLR_FARMCAR         = 227,                 
            "东方红",                          //VLR_DONGFANGHONG    = 228,                 
            "斯太尔汽车",                      //VLR_STEYR           = 229,                 
            "红旗",                            //VLR_HONGQI          = 230,                 
            "用户1",                           //VLR_USER1           = 231,                 
            "用户2",                           //VLR_USER2           = 232,                 
